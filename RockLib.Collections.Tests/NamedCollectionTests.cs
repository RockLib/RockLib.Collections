...
namespace RockLib.Collections.Tests
{
    public class NamedCollectionTests
    {
        ...
        {
            Func<NamedCollection<Foo>> action = () => new NamedCollection<Foo>(null!, f => f.Name!);
        ...
        public void ConstructorThrowsWhenGetNameIsNull()
        {
            ...
            Func<NamedCollection<Foo>> action = () => new NamedCollection<Foo>(values, null!);
        ...
        public void ConstructorThrowsWhenThereIsMoreThanOneDefaultValue()
        {
            ...
            Func<NamedCollection<Foo>> action = () => new NamedCollection<Foo>(values, f => f.Name!);
        ...
        public void ConstructorDoesNotThrowWhenThereIsMoreThanOneDefaultValueAndStrictIsFalse()
        {
            ...
            Func<NamedCollection<Foo>> action = () => new NamedCollection<Foo>(values, f => f.Name!, strict: false);
